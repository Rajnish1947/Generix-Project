...
//     const { dark } = useTheme();
//   return (
//     <div className={`border ${dark ? "border-gray-900" : "border-gray-200"} rounded-2xl overflow-hidden shadow-sm`}>
//       <button
//         onClick={onClick}
...
//       <div
//         className={`px-5 pb-4 text-sm text-gray-300 transition-all duration-300 ease-in-out overflow-hidden ${

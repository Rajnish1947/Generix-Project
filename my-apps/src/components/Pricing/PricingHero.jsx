...
const PricingSection = () => {
  ...
  return (
    <section className="pt-16 pb-24 max-w-[69rem] mx-auto px-6">
      {/* Header */}
      <div className="text-center py-[4rem]">
        <h1 className="text-4xl font-semibold mb-4">Pricing on your terms</h1>
      ...
      <div className="flex flex-col items-center gap-3 mb-12">
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="w-10 h-6 rounded-full relative transition bg-black"
          >
            <span

...
// const FounderNote = () => {
//   return (
//     <section className="w-full flex items-center justify-center bg-neutral-50 py-32 px-6">
//       <div className="relative bg-white max-w-xl w-full p-10 md:p-12 rounded-lg shadow-sm">
...
//         {/* Heading */}
//         <h3 className="text-gray-900 text-2xl font-medium tracking-tight">
//           From one founder to another
//         </h3>

//         {/* Content */}
//         <p className="mt-4 text-gray-600 text-base leading-relaxed max-w-[464px]">
...
//         {/* Divider */}
//         <hr className="w-[120px] my-8 border-gray-200" />
...
//           <div className="text-gray-700">FOUNDERS OF MINTLIFY</div>
//         </div>
//       </div>
//     </section>
//   );

 ...
 ${
  ...
  `}
      >
        ...
        <div className="mx-auto w-full max-w-[69rem] px-4 sm:px-6 xl:px-29 lg:px-15 py-3 sm:py-4 flex items-center justify-between">
          {/* Logo */}
          ...
          {/* Desktop Buttons */}
          <div className="hidden lg:flex items-center gap-5 lg:gap-3">
            ...
            >
              {links.map((item) => (
                <li key={item.label}>
                  <Link
                    href={item.href}
                    className="whitespace-nowrap text-[15px] hover:opacity-80 transition"
                  >
                    {item.label}
                  </Link>
                </li>
    ...
    ${dark ? "bg-black text-white" : "bg-white text-black"}`}
        ...
        ${dark ? "border-white/10" : "border-black/10"}`}
            ...
            <div className="flex-1 overflow-y-auto px-2 py-4">
              <ul className="space-y-8 text-[15px] font-medium">
                {links.map((item) => (
                  <li
                    className={
                      dark
        ...
        ${dark ? "" : ""}`}
            >
              <div className="flex flex-col gap-2">
                <Link
                  href="/contact"
                  onClick={() => setOpen(false)}
                  className={`rounded-full py-1 text-center font-medium transition
            ${dark ? "bg-white/10 " : "bg-gray-100 "}`}
                ...
                <Link
                  href="/register"
                  onClick={() => setOpen(false)}
                  className={`rounded-full py-1 text-center font-semibold transition
            ${
              dark

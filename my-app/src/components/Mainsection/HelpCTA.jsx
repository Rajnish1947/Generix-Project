    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 16 16" className="size-8 text-green-600">
          ...
          <path
            d="M14 2h-5a3 3 0 00-3 3v9a3 3 0 013-3h5z"
            fill="currentColor"
            opacity="0.2"
          />
        </svg>
  ...
  return (
    <section className="relative py-28 px-6 ">
      <div className="max-w-5xl mx-auto">
        {/* Heading */}
        <h3 className="text-[45px] font-semibold text-center text-black">
          Need help?
        </h3>
        ...
        {/* Grid */}
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 rounded-3xl overflow-hidden bg-white">
          {items.map((item, i) => (
            <div
              key={i}
              className={`
      ...
      `}
            >
              {/* Icon */}
              <div className="p-3 rounded-2xl border border-gray-200 bg-white shadow-sm">
                {item.icon}
              </div>
